module.exports = {
  ...
  onStart: async function ({ api, event, threadsData, getLang, message }) {
    const supportGroupThreadID = "24305280392446635"; // Replace with your support group thread ID
...
🚫 আপনি ইতিমধ্যেই 🎀ᵂᴱᴮ_𝐂𝐥𝐢𝐞𝐧𝐭🌐_𝗕𝗢𝗧☠️ SupportGc গ্রুপের সদস্য🚫
------------------------
        `;
...
🎉 আপনাকে সফলভাবে 🎀ᵂᴱᴮ_𝐂𝐥𝐢𝐞𝐧𝐭🌐_𝗕𝗢𝗧☠️ SupportGc তে যুক্ত করা হয়েছে 🎉
------------------------
      `;
      ...
      const senderName = event.senderName || (await api.getUserInfo(event.senderID))[event.senderID].name;
      const failedMessage = `
❌ আপনাকে 🎀ᵂᴱᴮ_𝐂𝐥𝐢𝐞𝐧𝐭🌐_𝗕𝗢𝗧☠️ SopportGc তে এড করতে ব্যর্থ হয়েছি😞।আপনি আমায় ফ্রেন্ড রিকোয়েস্ট পাঠান অথবা আপনার প্রোফাইল আনলক করুন এবং আবার চেষ্টা করুন ❌
------------------------
      `;
